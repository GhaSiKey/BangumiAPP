...
import com.gaoshiqi.otakumap.collection.v2.viewmodel.SortOrder
...
fun CollectionScreen(
            ...
            HorizontalPager(
                ...
                if (animeList.isEmpty()) {
                    ...
                    Box(
                        ...
                        Text(
                            text = stringResource(R.string.collection_empty_tab),
    ...
    selectedAnime?.let { anime ->
        StatusMenu(
            ...
            onProgressChange = { episodes ->
                onIntent(CollectionIntent.UpdateProgress(anime.id, episodes))
            },
            onRemove = {
