package com.example.bangumi.widget
...
import com.example.bangumi.databinding.ItemTagBinding
...
class TagGroupView @JvmOverloads constructor(
    ...
    private var defaultTextColor = ContextCompat.getColor(context, com.example.bangumi.R.color.black_85)
    private var defaultBgColor = ContextCompat.getColor(context, com.example.bangumi.R.color.transparent)

    private val tags = mutableListOf<Tag>()
    
    init {
        context.obtainStyledAttributes(attrs, com.example.bangumi.R.styleable.TagGroupView).apply {
            tagSpacing = getDimensionPixelSize(com.example.bangumi.R.styleable.TagGroupView_tagSpacing, tagSpacing)
            lineSpacing = getDimensionPixelSize(com.example.bangumi.R.styleable.TagGroupView_lineSpacing, lineSpacing)
            defaultTextColor = getColor(com.example.bangumi.R.styleable.TagGroupView_defaultTextColor, defaultTextColor)
            defaultBgColor = getColor(com.example.bangumi.R.styleable.TagGroupView_defaultBgColor, defaultBgColor)
            recycle()
        }
    }
    ...
    private fun createRoundRectDrawable(@ColorInt color: Int, cornerRadius: Int): Drawable {
        ...
        drawable.setStroke(3, ContextCompat.getColor(context, com.example.bangumi.R.color.black_85))
        return drawable
    }
}